...
FeaturePlot(mLN_Ontogeny.integrated, features.plot = c("Cd34","Ccl19","Pecam1","Ackr4"), 
            min.cutoff = "q9",
            cols.use = c('lightgrey', 'brown'),
            pt.size = 0.2)

FeaturePlot(mLN_Ontogeny.integrated, features.plot = c("Fam46a"), 
...
FeaturePlot(mLN_Ontogeny_minus.merged, features.plot = c("Cd34","Cdk1","Cd248","Aldh1a2"), 
            #"Tinagl1","Cdk1"),
            min.cutoff = "q9",
            cols.use = c('lightgrey', 'brown'),
            pt.size = 0.2)

FeaturePlot(mLN_Ontogeny_minus.merged, features.plot = c("Cd34","Ccl19","Atxn1","Ly6a"), 
            #"Tinagl1","Cdk1"),
            min.cutoff = "q9",
            cols.use = c('lightgrey', 'brown'),
            pt.size = 0.2)
